...
// â”€â”€â”€ Onboarding guard â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ App content (inside providers) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function AppContent() {
  ...
  // â”€â”€ Effect 1: Channels + listeners + watchdog (NO permission request) â”€â”€â”€â”€â”€
  //
  // Android notification channels are set up here â€” they don't need permission.
  ...
  useEffect(() => {
    // 1. Set up Android channels immediately â€” no permission dialog triggered
    ...
    // 3. Persistent question reminder cycle â€” foreground delivery handler
    //
    ...
    //    periodic watchdog (item 5 below) covers this gap â€” it runs every
    ...
    // 5. AppState watchdog â€” runs on every backgroundâ†’foreground transition.
    //
    ...
    //      c) The user brings the app to foreground â€” this handler runs.
    ...
    //         and persists the new date â€” fully restoring the chain.
    const appStateSub = AppState.addEventListener("change", (nextState: AppStateStatus) => {
      if (appStateRef.current.match(/inactive|background/) && nextState === "active") {
        invalidatePermissionCache();
        // Run the watchdog â€” respects its own 30-second cooldown, so rapid
    ...
    // 6. Periodic foreground watchdog â€” runs every 10 minutes while the app
    //    is active.
    //
    ...
    //    â€” potentially hours â€” until the user backgrounds and foregrounds the app.
    //
    ...
    //    one immediately â€” restoring the chain within the next 10-minute window.
  ...
  // â”€â”€ Effect 2: Permission request â€” deferred until app is initialized â”€â”€â”€â”€â”€â”€â”€
  //
  ...
  //      schedules all pending notifications â€” the user does NOT need to restart
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (granted) {
        ...
        //   a) First launch: the user just granted permission â€” schedule all
        ...
        //      permission was in an intermediate state (undetermined â†’ granted):
