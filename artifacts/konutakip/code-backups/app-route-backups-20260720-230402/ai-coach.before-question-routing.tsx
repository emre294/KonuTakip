  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: "assistant",
      content:
        "Merhaba! Ben KonuTakip AI Ã§alÄ±ÅŸma koÃ§unum. Konu anlatÄ±mÄ±, soru Ã§Ã¶zÃ¼mÃ¼ veya Ã§alÄ±ÅŸma planÄ± hakkÄ±nda bana soru sorabilirsin.",
    },
  ]);
      ...
      >
        ...
        <View style={styles.headerCenter}>
          ...
          <View style={styles.headerText}>
            ...
            >
              YKS iÃ§in kiÅŸisel yardÄ±mcÄ±n
            </Text>
          </View>
        </View>
      ...
      >
        ...
        >
          <TextInput
            ...
            placeholder="AI koÃ§una bir soru sor..."
