    ...
    if (isQuestionRequest(cleanMessage)) {
      setMessages((current) => [
        ...current,
        {
          ...
          role: "assistant",
          content:
            "📚 Bu isteğin soru çözmeye yönelik görünüyor.\n\nAI Öğretmen; soru çözme, konu anlatımı, fotoğraf ve PDF analizi için tasarlanmıştır.\n\nSeni AI Öğretmen ekranına yönlendiriyorum...",
        },
      ]);
